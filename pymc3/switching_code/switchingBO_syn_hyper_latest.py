...
class synthetic_uni_problem: # added on Apr 17, 2025 # updated on May 18, 2025
...
def synthetic_objective1(x, xi):
    ##follow Enlu Zhou 2024 OR: Data-Driven Ranking and Selection Under IU, but add 10*xi to make the different optimal objective value (updated on May 18, 2025)
    return (x-xi)**2 + 5*xi 

def synthetic_true_objective1(x, theta_c, known_sigma):

    return (x-theta_c)**2 + known_sigma**2 + 5*theta_c
