...
def exp_BRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            df.to_csv('log_real_inventory_no_RS_BRO_random.csv', mode='a', header=not os.path.exists('log_real_inventory_no_RS_BRO_random.csv'), index=False)
...
cmd = ['-t','20250513-no-RS-BRO-random-2regime-real-48data-seed-60-69', 
