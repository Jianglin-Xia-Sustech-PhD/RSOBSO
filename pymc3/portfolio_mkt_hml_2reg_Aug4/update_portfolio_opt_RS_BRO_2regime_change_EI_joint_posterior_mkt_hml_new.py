...
def SwitchingBRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            log_df.to_csv('log_portfo_2regime_48data_RS_BRO_EIjoint_mkt_hml.csv', mode='a', header=not os.path.exists('log_portfo_2regime_48data_RS_BRO_EIjoint_mkt_hml.csv'), index=False)
...
cmd = ['-t','p0101-RS-BRO-EI-jo-posterior-portfolio-mkt-hml-new-2regime-48data-seed40-44', 
