...
def EGO_posterior_mean_plug_in(seed):
    ...
    for t in range(n_timestep):
        ...
        df.to_csv('log_portfo_2regime_48data_no_RS_plug_mkt_hml.csv', mode='a', header=not os.path.exists('log_portfo_2regime_48data_no_RS_plug_mkt_hml.csv'), index=False)
...
cmd = ['-t','p0103-no-RS-plug-portfolio-2regime-mkt-hml-new-48data-seed40-44', 
