import time
from switching_code.switchingBO_edit_obj_updated_newest_gaussian_portfolio_add_kde import *
...
def no_RS_bayesian_kde(seed):
    ...
    for t in range(n_timestep):
        ...
        saved_path = f"/home/admin1/HEBO/MCMC/pymc3-hmm-main/kde_plot/portfolio_2regime_9country/seed{seed}_kde_plot_timestep{t}.pdf"
...
cmd = ['-t','30260305-no-RS-kde-portfolio-9Country-2regime-48data-seed40-44', 
