...
def EGO_posterior_mean_plug_in(seed):
    ...
    for t in range(n_timestep):
        ...
        df.to_csv('log_real_inventory_4regime_96data_redesign_recession_no_RS_plug_mean.csv', mode='a', header=not os.path.exists('log_real_inventory_4regime_96data_redesign_recession_no_RS_plug_mean.csv'), index=False)
...
cmd = ['-t','20250608-no-RS-plug-mean-4regime-real-96data-redesign-recession-seed-60-69', 
