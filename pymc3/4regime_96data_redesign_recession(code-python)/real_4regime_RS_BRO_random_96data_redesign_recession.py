...
def SwitchingBRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            df.to_csv('log_real_inventory_4regime_96data_redesign_recession_RS_BRO_random.csv', mode='a', header=not os.path.exists('log_real_inventory_4regime_96data_redesign_recession_RS_BRO_random.csv'), index=False)
...
cmd = ['-t','20250605-RS-BRO-random-4regime-real-96data-redesign-recession-seed-60-69', 
