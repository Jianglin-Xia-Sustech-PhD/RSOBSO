...
### plug-in: posterior sample mean (3000 currently, need change?)
# %%
...
def SwitchingPlug_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for i in range(n_iteration):
            ...
            df.to_csv('log_real_inventory_4regime_96data_redesign_recession_RS_plug_mean.csv', mode='a', header=not os.path.exists('log_real_inventory_4regime_96data_redesign_recession_RS_plug_mean.csv'), index=False)
...
cmd = ['-t','20250606-RS-plug-mean-4regime-real-96data-redesign-recession-seed-60-69', 
