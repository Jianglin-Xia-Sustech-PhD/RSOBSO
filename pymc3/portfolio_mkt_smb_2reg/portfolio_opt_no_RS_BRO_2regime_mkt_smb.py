...
def gaussian_BRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            df.to_csv('log_portfo_2regime_48data_no_RS_BRO_mkt_smb.csv', mode='a', header=not os.path.exists('log_portfo_2regime_48data_no_RS_BRO_mkt_smb.csv'), index=False)
...
cmd = ['-t','p0104-no-RS-BRO-portfolio-2regime-mkt-smb-48data-seed40-44', 
