...
def SwitchingBRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            df.to_csv('log_portfo_2regime_48data_RS_plug_mkt_smb.csv', mode='a', header=not os.path.exists('log_portfo_2regime_48data_RS_plug_mkt_smb.csv'), index=False)
...
cmd = ['-t','p0102-RS-plug-portfolio-2regime-mkt-smb-48data-seed40-44', 
       ...
       '-mu_prior_upper', '50.0', ###20.0 (change)
       '-sigma_prior_lower', '0.1', ###0.1 
       '-sigma_prior_upper', '20.0', ###10.0
