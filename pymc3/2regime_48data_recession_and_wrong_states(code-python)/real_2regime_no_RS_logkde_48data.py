...
def no_RS_bayesian_kde(seed):
    ...
    for t in range(n_timestep):
        ...
        saved_path = f"/home/admin1/HEBO/MCMC/pymc3-hmm-main/kde_plot/real_inventory/2regime_48data/seed{seed}_kde_plot_timestep{t}.pdf"
...
cmd = ['-t','20250516-no-RS-logkde-2regime-real-48data-seed-60-69', 
...
dimension_x = f.dimension_x
lower_bound = [1,70] #### same setting as wsc and switchingBO
upper_bound = [69, 250]
