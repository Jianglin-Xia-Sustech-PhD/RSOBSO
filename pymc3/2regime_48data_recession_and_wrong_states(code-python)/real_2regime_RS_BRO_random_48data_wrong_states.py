...
### identify the number of states wrongly: real 2-regime, wrongly identify as 3-regime
...
def SwitchingBRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            df.to_csv('log_real_inventory_2regime_48data_wrong_3_RS_BRO_random.csv', mode='a', header=not os.path.exists('log_real_inventory_2regime_48data_wrong_3_RS_BRO_random.csv'), index=False)
...
cmd = ['-t','20270101-RS-BRO-random-2regime-real-48data-wrong-3regime-seed-60-69', 
...
window = args.window
n_MCMC = args.n_MCMC
n_components = args.n_components #number of hidden states (maybe wrong given)
