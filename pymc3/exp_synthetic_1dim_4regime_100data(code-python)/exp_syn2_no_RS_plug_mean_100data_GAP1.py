...
def EGO_posterior_mean_plug_in(seed):
    ...
    for t in range(n_timestep):
        ...
        df.to_csv('log_syn2_4regime_100data_no_RS_plug_mean.csv', mode='a', header=not os.path.exists('log_syn2_4regime_100data_no_RS_plug_mean.csv'), index=False)
...
cmd = ['-t','20260103-exp-syn2-no-RS-plug-mean-4regime-100data-seed-60-69', 
