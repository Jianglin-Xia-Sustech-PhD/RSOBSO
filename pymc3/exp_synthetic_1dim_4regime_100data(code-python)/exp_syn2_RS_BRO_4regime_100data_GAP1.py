...
def SwitchingBRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            df.to_csv('log_exp_syn2_4regime_100data_RS_BRO_random.csv', mode='a', header=not os.path.exists('log_exp_syn2_4regime_100data_RS_BRO_random.csv'), index=False)
...
cmd = ['-t','20260101-exp-syn2-RS-BRO-random-4regime-100data-seed-60-69', 
