...
def exp_BRO_streaming(seed):
    ...
    for t in range(n_timestep):
        ...
        for ego_iter in range(n_iteration):
            ...
            df.to_csv('log_syn2_4regime_100data_no_RS_BRO_random.csv', mode='a', header=not os.path.exists('log_syn2_4regime_100data_no_RS_BRO_random.csv'), index=False)
...
cmd = ['-t','20260104-exp-syn2-no-RS-BRO-random-4regime-100data-seed-60-69', 
